...
def fetch_stock_volume(stock_ticker, start_date, end_date):
    try:
        stock_data = yf.download(stock_ticker, start=start_date, end=end_date)
        if stock_data.empty:
            print(f"警告: 未找到 {stock_ticker} 在 {start_date} 到 {end_date} 之間的資料。")
            return None
        if 'Volume' not in stock_data.columns:
            print(f"警告: {stock_ticker} 的資料中缺少 'Volume' 欄位。")
            return None
        volume_data = stock_data[['Volume']].reset_index()
        volume_data.columns = ['Date', 'Volume']
        # 將日期格式轉為字串，以便與資料庫中的日期匹配
        volume_data['Date'] = volume_data['Date'].dt.strftime('%Y-%m-%d')
        return volume_data
    except Exception as e:
        print(f"抓取 {stock_ticker} 資料時發生錯誤: {e}")
        return None

def update_database_with_volume(volume_df, db_connection_string, db_name, collection_name, stock_code):
    try:
        ...
        for index, row in volume_df.iterrows():
            ...
            if result.matched_count > 0:
                print(f"更新成功: {stock_code} - {row['Date']} 的 volume 為 {row['Volume']}")
            else:
                print(f"未找到匹配的文件，無法更新: {stock_code} - {row['Date']}")
        
        client.close()
    except Exception as e:
        print(f"更新 {stock_code} 資料庫時發生錯誤: {e}")

def main():
    print("台股單日交易量抓取並更新資料庫程式")

    # 固定的參數設定
    stock_tickers = ['1101.TW', '1102.TW', '1103.TW', '1104.TW', '1108.TW', '1109.TW', '1110.TW', '1201.TW', '1203.TW', '1210.TW', '1213.TW', '1215.TW', '1216.TW', '1217.TW', '1218.TW', '1219.TW', '1220.TW', '1225.TW', '1227.TW', '1229.TW', '1231.TW', '1232.TW', '1233.TW', '1234.TW', '1235.TW', '1236.TW', '1256.TW', '1301.TW', '1303.TW', 
...
'6477.TW', '6491.TW', '6504.TW', '6505.TW', '6515.TW', '6525.TW', '6526.TW', '6531.TW', '6533.TW', '6541.TW', '6550.TW', '6552.TW', '6558.TW', '6573.TW', '6579.TW', '6581.TW', '6582.TW', '6585.TW', '6591.TW', '6592.TW', '6598.TW', '6605.TW', '6606.TW', '6625.TW', '6641.TW', '6655.TW', '6657.TW', '6658.TW', '6666.TW', '6668.TW', '6669.TW', '6670.TW', '6671.TW', '6672.TW', '6674.TW', '6689.TW', '6691.TW', '6695.TW', '6698.TW', '6706.TW', '6715.TW', '6719.TW', '6742.TW', '6743.TW', '6753.TW', '6754.TW', '6756.TW', '6768.TW', '6770.TW', '6776.TW', '6781.TW', '6782.TW', '6789.TW', '6790.TW', '6792.TW', '6796.TW', '6799.TW', '6805.TW', '6806.TW', '6807.TW', '6830.TW', '6834.TW', '6835.TW', '6861.TW', '6863.TW', '6901.TW', '6906.TW', '6916.TW', '6933.TW', '6937.TW', '8011.TW', '8016.TW', '8021.TW', '8028.TW', '8033.TW', '8039.TW', '8046.TW', '8070.TW', '8072.TW', '8081.TW', '8101.TW', '8103.TW', '8104.TW', '8105.TW', '8110.TW', '8112.TW', '8114.TW', '8131.TW', '8150.TW', '8163.TW', '8201.TW', '8210.TW', '8213.TW', '8215.TW', '8222.TW', '8249.TW', '8261.TW', '8271.TW', '8341.TW', '8367.TW', '8374.TW', '8404.TW', '8411.TW', '8422.TW', '8429.TW', '8438.TW', '8442.TW', '8443.TW', '8454.TW', '8462.TW', '8463.TW', '8464.TW', '8466.TW', '8467.TW', '8473.TW', '8476.TW', '8478.TW', '8481.TW', '8482.TW', '8488.TW', '8499.TW', '8926.TW', '8940.TW', '8996.TW', '9802.TW', '9902.TW', '9904.TW', '9905.TW', '9906.TW', '9907.TW', '9908.TW', '9910.TW', '9911.TW', '9912.TW', '9914.TW', '9917.TW', '9918.TW', '9919.TW', '9921.TW', '9924.TW', '9925.TW', '9926.TW', '9927.TW', '9928.TW', '9929.TW', '9930.TW', '9931.TW', '9933.TW', '9934.TW', '9935.TW', '9937.TW', '9938.TW', '9939.TW', '9940.TW', '9941.TW', '9942.TW', '9943.TW', '9944.TW', '9945.TW', '9946.TW', '9955.TW', '9958.TW']
    ...
    # MongoDB 連接資訊
    db_connection_string = "mongodb://localhost:27017/"  # 替換為您的 MongoDB 連接字串
    db_name = "test"  # 替換為您的資料庫名稱
    collection_name = "price"  # 替換為您的集合名稱
    ...
    for stock_ticker in stock_tickers:
        print(f"\n處理股票代號: {stock_ticker}")
        # 抓取資料
        volume_df = fetch_stock_volume(stock_ticker, start_date, end_date)

        if volume_df is not None:
            print(f"抓取到的 {stock_ticker} 交易量資料：")
            print(volume_df)
            # 提取股票代號（不包含 '.TW'）
            stock_code = stock_ticker.replace(".TW", "")
            # 更新資料庫
            update_database_with_volume(volume_df, db_connection_string, db_name, collection_name, stock_code)
        else:
            print(f"跳過 {stock_ticker}，因為未成功抓取交易量資料。")
